...
- **Update CI resource strategy.** Type-checker and builder parallelization flags can drastically change throughput and memory behavior depending on runner profiles. Benchmark with your own monorepo topology before locking defaults.
