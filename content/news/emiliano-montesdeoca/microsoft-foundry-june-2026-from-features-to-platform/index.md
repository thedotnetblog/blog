...
- **For toolbox-heavy agents**, enable tool search early to reduce context noise and wrong-tool selection risk as catalogs grow.
- **For memory-enabled agents**, define TTL and retention policy up front. Memory without lifecycle controls becomes compliance debt.
