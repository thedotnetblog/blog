...
description: "Resume pratique pour les equipes .NET sur \"Combiner le versionnement d'API avec OpenAPI dans .NET 10\", avec des etapes concretes pour la production."
tags:
  - .NET
  - API Design
  - OpenAPI
...
[Combiner le versionnement d'API avec OpenAPI dans .NET 10](https://devblogs.microsoft.com/dotnet/api-versioning-in-dotnet-10-applications/) merite l'attention des equipes qui construisent et exploitent des systemes .NET en production.
...
- Article original: [https://devblogs.microsoft.com/dotnet/api-versioning-in-dotnet-10-applications/](https://devblogs.microsoft.com/dotnet/api-versioning-in-dotnet-10-applications/)
