...
Start with file-based skills for policy-heavy content maintained by mixed technical teams. Use class-based skills when you need package distribution through NuGet and tighter engineering lifecycle controls. Reserve code-defined skills for dynamic runtime assembly where stateful composition is necessary.
