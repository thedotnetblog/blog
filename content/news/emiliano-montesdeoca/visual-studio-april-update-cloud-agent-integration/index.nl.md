...
[Visual Studio April Update: Cloud Agent Integration for .NET Workflows](https://devblogs.microsoft.com/visualstudio/visual-studio-april-update-cloud-agent-integration/) is het waard om goed naar te kijken als je .NET-systemen op schaal bouwt of beheert.
...
- Origineel artikel: [https://devblogs.microsoft.com/visualstudio/visual-studio-april-update-cloud-agent-integration/](https://devblogs.microsoft.com/visualstudio/visual-studio-april-update-cloud-agent-integration/)
