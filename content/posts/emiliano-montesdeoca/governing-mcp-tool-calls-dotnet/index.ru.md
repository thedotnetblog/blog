...
description: "Как внедрить управление, проверки политик и более безопасное выполнение инструментов для .NET-агентов на основе MCP."
tags:
  - .NET
  - MCP
  - AI Agents
...
[Governing MCP Tool Calls in .NET with the Agent Governance Toolkit](https://devblogs.microsoft.com/dotnet/governing-mcp-tool-calls-in-dotnet-with-the-agent-governance-toolkit/) заслуживает внимания, если вы создаёте или эксплуатируете .NET-системы в масштабе.
...
- Оригинальная статья: [https://devblogs.microsoft.com/dotnet/governing-mcp-tool-calls-in-dotnet-with-the-agent-governance-toolkit/](https://devblogs.microsoft.com/dotnet/governing-mcp-tool-calls-in-dotnet-with-the-agent-governance-toolkit/)
